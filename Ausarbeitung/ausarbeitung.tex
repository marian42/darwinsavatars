...
\begin{figure}[H]
	...
	\caption{Genotyp mit Sensoren J0, J1 und Effektoren E0, E1 \cite{Sims94} und der zugehörige Phänotyp \label{fig:extendedgraph}}
\end{figure}
...
%-------------------------------------------------------------------------------
% Formatierungsfehler muss noch behoben werden
%-------------------------------------------------------------------------------
