...
Diese Kanten zeigen auf den gleichen Knoten von dem sie ausgehen.
...
\begin{figure}[H]
	...
	\caption{Genotyp mit Sensoren J0, J1 und Effektoren E0, E1 und der zugehörige Phänotyp \cite{Sims94} \label{fig:extendedgraph}}
\end{figure}
...
%-----------------------------------------------------------------------------
% Abbildung muss ggf. noch nachgebessert werden
%-----------------------------------------------------------------------------
