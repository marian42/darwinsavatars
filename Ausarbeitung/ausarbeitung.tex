...
Einen weiteren interessanten Ansatz zur prozeduralen Generierung findet man im Pflanzenzucht Spiel Petalz \cite{RiLe15}. Ähnlich wie in Darwin's Avatars werden die Inhalte prozedural generiert, dabei handelt es sich um ein Social Game, welche beispielsweise in Facebook gefunden werden können. Die Blumen sind einzigartig und bieten viele Anpassungsmöglichkeiten. Sie werden durch neuronale Netzwerke generiert, die sich in ihren  Funktionen unterscheiden.
