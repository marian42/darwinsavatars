...
\begin{figure}[H]
	...
	\caption{Screenshot aus \textsc{Darwin's Avatars}. Wer zuerst das Ende der Strecke erreicht, gewinnt}
\end{figure}
...
Dieser Algorithmus wird bei Lessin, Fussel und Miikkulainen \cite{LeFuMi13} im Detail beschrieben und basiert auf der Arbeit von Sims \cite{Sims94}.
