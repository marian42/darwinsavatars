...
\definecolor{hellgruen}{rgb}{0.6549,0.8,0.36} % changed this
...
\begin{frame}
	...
	\textbf{Neuronales Netz}: Abbildung von Rechenoperationen durch einen Graphen\\ \pause
	\begin{itemize}
		\item Neuronen wenden Funktionen auf ein Eingangssignal an \pause
		\begin{itemize}
			\item Beispiele sind Summe, Produkt, Sinus, boolesche Operationen \pause
		\end{itemize}
		\item Eingänge: Sensoren \pause
		\begin{itemize}
			\item Länge von jedem Muskel \pause
			\item Weitere Sensoren möglich, aber nicht im Spiel enthalten \pause
		\end{itemize}
		\item Ausgänge: Effektoren \pause
		\begin{itemize}
...
\begin{frame}[t]
	...
	\textbf{Paarung: Zufällige Kombination von zwei Kreaturen (Methode A)} \\
	\vspace{1em}
	...
	\vspace{1em}
	\pause	
	\textbf{Methode A}: Nehme Knoten eines Elternteils und ersetze zufällige Knoten durch die des anderen Elternteils an der gleichen Position
	\vspace{2em}
\end{frame}
...
\begin{frame}[t]
	...
	\textbf{Paarung: Zufällige Kombination von zwei Kreaturen (Methode B)} \\
	\vspace{1em}
	...
	\begin{center}
		\includegraphics[width=0.73\textwidth]{img/pfeile2.png}
	\end{center}
